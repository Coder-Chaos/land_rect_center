...
#include <land_rect_center/center.h> // 导入自定义消息类型
...
land_rect_center::center landmark;
void center_cb(const land_rect_center::center::ConstPtr& msg){
    landmark = *msg;
}

int main(int argc, char **argv)
{
    ros::init(argc, argv, "land_rect_center_node");
    ros::NodeHandle nh;
    ...
    ros::Subscriber center_sub = nh.subscribe<land_rect_center::center>
            ("center", 10, center_cb);
